    ...
    <div class="site-wrap">
                        ...
                        <div class="col-12">
                            <div class="row align-items-center">
                                <div class="col-lg-6 mb-4">
                                    <h1 data-aos="fade-up" data-aos-delay="100">Atualize os dados</h1>
                                ...
                                <div class="col-lg-5 ml-auto" data-aos="fade-up" data-aos-delay="500">
                                    <form action="" method="POST" class="form-box">
                                        <h3 class="h4 text-black mb-4">Atualizar Usuário</h3>
                                        ...
                                        <div class="form-group">
                                            ...
                                            <input type="submit" data-aos="fade-up" data-aos-delay="300" class="btn btn-primary py-3 px-5 btn-pill" value="atualizar" > 
     ...
     if ($conn->connect_error) {
         die("Connection failed: " . $conn->connect_error);
          ...
          $sql = "UPDATE estudante SET nome  = '$name', senha = '$senha' WHERE idEs = '$id';";
